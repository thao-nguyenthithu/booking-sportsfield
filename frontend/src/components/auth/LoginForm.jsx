  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.data.token) {
        ...
        if (response.data.user.role === 'ADMIN' || response.data.user.role === 'ROLE_ADMIN') {
          navigate('/admin');
        } else if (response.data.user.role === 'OWNER' || response.data.user.role === 'ROLE_OWNER') {
          navigate('/owner/dashboard');
        } else if (response.data.user.role === 'PLAYER' || response.data.user.role === 'ROLE_PLAYER') {
